...
from AaronTools.substituent import RingFragment
...
for infile in args.infile:
    ...
    for sub_info in args.substitutions:
        ...
        if args.form[0] == 'from_library':
            ...
            prering = Geometry.from_string(ring, form=args.form[0])
            end1 = prering.atoms[0]
            end2 = [atom for atom in end1.connected if atom.element != 'H'][0]
            ring_geom = RingFragment(prering, name=ring, end=[end1, end2])
