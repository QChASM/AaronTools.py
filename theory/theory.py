...
"""
    ...
    def make_header(self, geom, style='gaussian', conditional_kwargs={}, **kwargs):
        """geom: Geometry
        ...
        if style == "gaussian":
            return self.get_gaussian_header(conditional_kwargs=conditional_kwargs, **other_kw_dict)
        
        elif style == "orca":
            return self.get_orca_header(conditional_kwargs=conditional_kwargs, **other_kw_dict)
        
        elif style == "psi4":
            return self.get_psi4_header(conditional_kwargs=conditional_kwargs, **other_kw_dict)
    
    def make_footer(self, geom, style='gaussian', conditional_kwargs={}, **kwargs):
        """geom: Geometry
        ...
        if style == "gaussian":
            return self.get_gaussian_footer(conditional_kwargs=conditional_kwargs, **other_kw_dict)

        elif style == "psi4":
            return self.get_psi4_footer(conditional_kwargs=conditional_kwargs, **other_kw_dict)

    def get_gaussian_header(self, return_warnings=False, conditional_kwargs={}, **other_kw_dict):
    ...
    def get_gaussian_footer(self, return_warnings=False, conditional_kwargs={}, **other_kw_dict):
    ...
    def get_orca_header(self, return_warnings=False, conditional_kwargs={}, **other_kw_dict):
    ...
    def get_psi4_header(self, return_warnings=False, conditional_kwargs={}, **other_kw_dict):
    ...
    def get_psi4_footer(self, return_warnings=False, conditional_kwargs={}, **other_kw_dict):
        """get psi4 footer"""
